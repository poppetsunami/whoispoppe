...
const projects: ProjectCard[] = [
  {
    ...
    role: "Led a three-month discovery, interviewed 10 dealers, and iterated product concepts spanning service work management, reporting, and equipment diagnostics. Partnered with two product owners and business stakeholders to define a configurable work-management direction and prioritized roadmap, then continued through six months of dual-track delivery.",
